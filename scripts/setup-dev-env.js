...
console.log(`7. Update your .env.development file with the new connection string:`);
...
if (dockerInstalled) {
  ...
  console.log('   DATABASE_URL=postgresql://admin:admin@localhost:5432/saas-starter-kit\n');
} else {
  console.log('⚠️ Docker not detected. For local database setup, please install Docker and Docker Compose.\n');
}
